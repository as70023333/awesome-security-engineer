...
Focusing on Cloud Security Architecture, Infrastructure-as-Code (IaC), Zero Trust Identity, and Automated Threat Governance across AWS & Azure enterprise environments.
...
| :--- | :--- |
| **Cloud Platforms** | AWS (Control Tower, GuardDuty, Security Hub), Azure (Entra ID, Defender for Cloud) |
| **Infrastructure & Security as Code** | Terraform, OpenTofu, Ansible, OPA / Rego, Checkov, Trivy |
| **Security Operations** | Zero Trust Architecture (ZTA), CIS Benchmarks, Incident Response, SIEM / Datadog |
| **Systems & Scripting** | Linux (Bash/Zsh), Python, Go, CI/CD (GitHub Actions, GitLab CI) |
...
* **Tech:** Go, Rego, AWS SDK, Azure SDK, Docker.
...
* **Tech:** Python, Entra ID API, AWS STS, Webhooks.
...
* **Tech:** Terraform, Bash, GitHub Actions.
